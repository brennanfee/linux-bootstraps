...
#
# Short URL: https://tinyurl.com/deb-stable-vm
# Github URL: https://raw.githubusercontent.com/brennanfee/linux-bootstraps/main/scripted-installer/debian/debian-my-configs/stable-vm.bash
#
#
##################  MODIFY THIS SECTION
