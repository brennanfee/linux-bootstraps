...
#
# This configuration uses the main disk "smallest" selection option ignores any secondary disks.  It does not enable disk encryption. And finally it pauses with confirmation before final installation.
#
