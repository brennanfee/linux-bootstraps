...
#
# This configuration uses the main disk "smallest" and secondary disk "largest" selection options.  It does not enable disk encryption. And finally it pauses with confirmation before final installation.
#
