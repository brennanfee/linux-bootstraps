...
#
# Short URL:
# Github URL: https://raw.githubusercontent.com/brennanfee/linux-bootstraps/main/scripted-installer/debian/debian-home-configs/backports-single-disk.bash
#
#
##################  MODIFY THIS SECTION
...
read_input_options() {
  ...
  export AUTO_USE_DATA_DIR=${AUTO_USE_DATA_DIR:=1}
