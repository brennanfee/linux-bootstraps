...
#
# This configuration uses the main disk "smallest" and secondary disk "largest" selection options.  It enables encryption for both disks. And finally it pauses with confirmation before final installation.
#
