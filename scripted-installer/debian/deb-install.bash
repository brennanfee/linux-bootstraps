...
AUTO_OVERRIDE_REPO_URL="${AUTO_OVERRIDE_REPO_URL:=}"
...
log_values() {
  ...
  write_log "AUTO_OVERRIDE_REPO_URL: '${AUTO_OVERRIDE_REPO_URL}'"
  write_log_blank
...
confirm_with_user() {
  ...
  then
    ...
    print_status "The selected keymap is '${AUTO_KEYMAP}', and the selected timezone is '${AUTO_TIMEZONE}'."
...
normalize_parameters() {
  ...
  normalize_variable_string "AUTO_OVERRIDE_REPO_URL"
...
parse_repo_url() {
  ...
  if [[ "${AUTO_OVERRIDE_REPO_URL}" != "" ]]
  then
    SELECTED_REPO_URL="${AUTO_OVERRIDE_REPO_URL}"
  fi
}
